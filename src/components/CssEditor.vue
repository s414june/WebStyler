<template>
  <div v-if="props.showEditor" @click.self="emit('close')"
    ...
    <div class="border-l bg-zinc-50 flex-1 w-full">
      <div class="p-3 pt-5 h-full flex flex-col">
        ...
        <textarea v-model="css" class="w-full h-full resize-none border rounded p-2 font-mono text-xs"
          placeholder="寫點 CSS 試試吧"></textarea>
